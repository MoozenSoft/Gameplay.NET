...
代码放在 `src/Gameplay/Gameplay.Tags/` 目录。

## 1. 整体架构

```
src/Gameplay/Gameplay.Tags/
...
tests/Gameplay.Tests/Gameplay.Tests.Tags/
└── GameplayTagTests.cs
```
...
文件：`src/Gameplay/Gameplay.Tags/GameplayTagManager.cs`
...
文件：`src/Gameplay/Gameplay.Tags/GameplayTag.cs`
...
文件：`src/Gameplay/Gameplay.Tags/GameplayTagNode.cs`
...
文件：`src/Gameplay/Gameplay.Tags/GameplayTagSet.cs`
...
文件：`src/Gameplay/Gameplay.Tags/GameplayTags.cs`
...
文件：`tests/Gameplay.Tests/Gameplay.Tests.Tags/GameplayTagTests.cs`
