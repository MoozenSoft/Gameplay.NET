...
/// <summary>
/// Task 的归属信息——谁创建了这个 Task（Ability / AI / Quest / 任意 Entity）。<br/>
/// 层次关系（<see cref="Entity.AddChild"/>/ChildEntities）用于 AllTasksDone 检测，
/// Owner 引用用于完成通知。替代旧 AbilityTaskContextComponent，不再绑定 Ability。
/// </summary>
