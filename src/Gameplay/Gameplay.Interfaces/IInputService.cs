...
/// <summary>输入服务抽象——采集设备输入供 ECS System 只读查询。</summary>
/// <remarks>
/// <para>对应架构"Input 边界"：Input Service 是 ECS 与非 ECS 的桥梁，System 不碰设备。</para>
/// <para>无输入环境（如 Dedicated Server）不注入服务——Input 类 Task 保持 Running。</para>
/// </remarks>
