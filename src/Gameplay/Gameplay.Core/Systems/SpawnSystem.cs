...
{
    private readonly List<(int PrefabId, int TeamId, Vector3 Position)> _pending = new();
    ...
    protected override void OnUpdate()
    {
        ...
        {
            _pending.Add((spawnPoint.PrefabId, spawnPoint.TeamId, transform.Position));
        ...
        {
            var (prefabId, teamId, position) = _pending[i];
